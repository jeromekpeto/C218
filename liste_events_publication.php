...
<div align ="center" style="margin-top: -70px" >
    <h2 class="">Publier - s&eacute;lectionnez une s&eacute;ance </h2>
...
/* Test s'il existe une image ou pas  */ {
        $tableau[$k] = "<br><a border=\"0\" class=\"lien1\" href=\"?id=9&el=" . $val['e_id'] . " \">". $val['fl_lib']."<br><img border=\"0\" width=\"100\" height=\"100\" src=\"images/events/event.png\"><br>" . $val['duree'] . "<br><br></a>";
    $k++;
}
