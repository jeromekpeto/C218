...
FROM p_event e
JOIN p_film f ON f.fl_id = e.fk_film_id  where e_etat_event = 2
ORDER BY f.fl_id  ";
...
/* Indique le nombre de colonne que l'on veut dans le tableau */$NbrCol = 3;

$NbLigne = 0;
if ($NbSeances != 0) {
    $k = 0;
    /* Cr�ation d'u tableau */
    echo "<table border=\"0\" BORDERCOLOR=\"0000CD\" width=\"100%\" cellspacing=\"0\" cellpadding=\"0\">";
    while ($k < $NbSeances)
