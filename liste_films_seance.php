...
<div align ="center" style="margin-top: -70px" >
    <h2 class="">Programmer une s&eacute;ance -  s&eacute;lectionnez le film</h2>
...
/* Test s'il existe une image ou pas  */ {
    if (empty($val['fl_image_film'])) {
        $tableau[$k] = "<a border=\"0\" class=\"lien2\" href=\"?id=7&el=" . $val['fl_id'] . "\">" . $val['fl_lib'] . "<br></a>";
    } else {
        $tableau[$k] = "<a border=\"0\" class=\"lien1\" href=\"?id=7&el=" . $val['fl_id'] . "\"><img border=\"0\" width=\"100\" height=\"100\" src=\"images/films/" . $val['fl_image_film'] . "\"><br>" . $val['fl_lib'] . "</a>";
    }
    $k++;
}
...
/* Indique le nombre de colonne que l'on veut dans le tableau */
$NbrCol = 5;
?>
<a href="?id=2">
